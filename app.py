...
with col2:
    ...
    with st.expander("사용자 인증하기"):
        ...
        st.info('본인 인증을 시작합니다. 눈을 깜박여주세요.')
        st.info('"Success" 안내 문구가 나오면 얼굴을 촬영해주세요.')  
        st.info('화면 중앙에 얼굴을 위치시키고 밝은 환경에서 눈, 코, 입이 잘 보이게 촬영해주세요.')
        ...
        if capture_button and webrtc_ctx.video_transformer:
            ...
            if captured_image is not None:
                ...
                st.image(captured_image, caption="캡처 이미지")
            else:
